...
export default function Navbar() {
  ...
  return (
    <nav className="border-b border-primary/10 bg-background/80 backdrop-blur-xl shadow-lg shadow-black/30 sticky top-0 z-50">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4">
        <div className="flex items-center gap-4">
          <Link
            href={dashboardPath}
            className="group relative font-bold text-lg tracking-widest px-4 py-1.5 rounded-md border border-primary/30 bg-primary/5 text-gradient-brand transition-all duration-300 hover:border-primary/60 hover:bg-primary/10 hover:shadow-[0_0_20px_rgba(16,185,129,0.15)]"
          >
            NEXUS
          </Link>
        ...
        <div className="flex items-center gap-3">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger className="flex items-center gap-2 rounded-md border px-3 py-2 text-sm">
              <span className="inline-block h-6 w-6 rounded-full bg-gradient-to-br from-primary/60 to-primary/30" />
              {user?.role}
            </DropdownMenuTrigger>
